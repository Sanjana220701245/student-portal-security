...
# Logic App for Alert Automation
resource "azurerm_logic_app_workflow" "alert_processor" {
  ...
  tags = {
    Environment = var.environment
    Purpose     = "AlertAutomation"
  }
}

# Storage Account for Terraform State (Optional - for remote state)
